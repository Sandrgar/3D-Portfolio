...
const experiences = [
  {
    title: "Full-Stack Web Developer/ Develhope course",
    company_name: "",
    icon: starbucks,
    iconBg: "#383E56",
    date: "February 2023 - August 2023",
    points: [
      'Course that allowed me to develop the frontend and backend of a web application. The path starts from the basics of Git, HTML and CSS and then proceeds with Javascript to then deepen the knowledge of frontend development with React and backend development with Node.',
